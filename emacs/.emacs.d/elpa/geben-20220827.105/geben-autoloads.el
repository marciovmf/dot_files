...
This is a minor mode.  If called interactively, toggle the `Geben mode'
...
evaluate the variable `geben-mode'.
...
`Geben-Full-Frame mode' mode.  If the prefix argument is positive,
